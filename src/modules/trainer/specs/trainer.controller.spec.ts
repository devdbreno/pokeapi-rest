...
describe('TrainerController', () => {
  const logger = new Logger(`${TrainersController.name}Spec`)
  ...
  describe('POST Endpoints', () => {
    describe('/trainers/:trainerId/pokemons', () => {
      it('addPokemonTrainer', async () => {
